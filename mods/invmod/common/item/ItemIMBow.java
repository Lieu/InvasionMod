...
public class ItemIMBow extends ItemBow
{
	...
	{
		itemIcon = par1IconRegister.registerIcon("invmod:" + getUnlocalizedName().substring(5));
		iconCharge1 = par1IconRegister.registerIcon("invmod:" + "sbowc1");
		iconCharge2 = par1IconRegister.registerIcon("invmod:" + "sbowc2");
		iconCharge3 = par1IconRegister.registerIcon("invmod:" + "sbowc3");
	}
	...
	public Icon getIconFromDamage(int i)
	{
		//if(i == 1)
		{
			...
			else if(mod_Invasion.getBowHackHandler().getDrawTimeLeft() <= 500)
			{
				return iconCharge1;
			}
			else if(mod_Invasion.getBowHackHandler().getDrawTimeLeft() <= 2400)
			{
				return iconCharge2;
			}
			else
