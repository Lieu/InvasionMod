...
public class RenderGiantBird extends RenderIMLiving
{
	...
	public RenderGiantBird()
	{
		...
		modelBird = (ModelVulture)mainModel;
	}
	...
	public void renderGiantBird(EntityIMBird entityBird, double renderX, double renderY, double renderZ, float interpYaw, float partialTick)
	{
		...
		//System.out.println(entityBird.getPrevRotationYawHeadIM() + ", " + entityBird.getRotationYawHeadIM());
		modelBird.resetSkeleton();
		modelBird.setFlyingAnimations(entityBird.getWingAnimationState(), entityBird.getLegAnimationState(), entityBird.getBeakAnimationState(),
									  roll, headYaw, headPitch, partialTick);
    ...
    {
		modelBird.setRotationAngles(par2, par3, par4, par5, par6, par7, par1EntityLiving);
